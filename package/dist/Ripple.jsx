...
import "./Ripple.css";
//ripples
function addRipple(element, event, color, opacity, blur, duration, fillAndHold, neverRemove, rippleElement, className) {
...
//ripple component
export function Ripples({ on = "click", color = "white", opacity = 1, blur = 0, duration = 500, fillAndHold = false, optimize = false, rippleElement, className, }) {
    ...
    return (<div aria-hidden ref={ripplesurfaceRef} style={style} {...eventHandlers}/>);
}
